let database = require("../database/config")
    ...
    function capturarDadosMaquina(idMaquina, idInstituicao) {
        ...
        m.so as so,
        m.emUso as emUso,
        (SELECT capacidade FROM hardware JOIN componente ON fkHardware = idHardware WHERE fkTipoHardware = 3 AND idMaquina = m.idMaquina TOP 1) 
        as nucleos,
        (SELECT capacidade FROM hardware JOIN componente ON fkHardware = idHardware WHERE fkTipoHardware = 2 AND idMaquina = m.idMaquina TOP 1) 
        as capacidadeCPU,
